...
const plan = buildLocalClusterPlan({
  ...
  relayerSubmitEnabled: process.env.RELAYER_SUBMIT_ENABLED,
  relayerReserveAccountAddress: process.env.RESERVE_ACCOUNT_ADDRESS,
  relayerMaxGasPriceOctas: process.env.RELAYER_MAX_GAS_PRICE_OCTAS,
  relayerReserveMinBalanceOctas: process.env.RELAYER_RESERVE_MIN_BALANCE_OCTAS,
  aptosCliCwd: process.env.APTOS_CLI_CWD ?? resolve(serviceRoot, ".."),
