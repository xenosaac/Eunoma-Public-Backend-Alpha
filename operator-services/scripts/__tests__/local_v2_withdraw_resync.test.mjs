...
//
// These cover the NON-I/O logic: WithdrawEventV2 parsing bound to the trusted package, the
...
function withdrawTx(pkg, seq, success = true) {
  return {
    success,
    ...
    events: [
      ...
      {
        type: `${pkg}::eunoma_bridge::WithdrawEventV2`,
        data: {
          root: "0xaa",
          nullifier_hash: "0xbb",
